...
<body>
     <div class="ctnr">
        ...
        <div class="numbers">
            ...
            <div class="num" id="ex"><p>
               <a href="../callinterface/call.php"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
